                    ...
                    else
                    {
                        ...
                        if (sectionLabel == 2)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (tmpStrs[5].Trim().Substring(0,1) == "L")
                                    {
                                        tmpStrs[1] = "-1";
                                    }
                                    else
                                ...
                                sb.Append(" " + tmpStrs[0].PadLeft(3).PadRight(9));
                                sb.Append(tmpStrs[1].PadLeft(5).PadRight(8));
                                sb.Append(tmpStrs[2].PadLeft(17).PadRight(20));
                                sb.Append(tmpStrs[3].PadLeft(17).PadRight(20));
                                sb.Append(tmpStrs[4].PadLeft(17).PadRight(20));
